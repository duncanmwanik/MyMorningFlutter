                    ...
                    Stack(
                      ...
                      children: [
                        ...
                        TimePickerSpinner(
                          ...
                          highlightedTextStyle: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: Colors.black),
                          spacing: 20,
                          itemHeight: 50,
                          isForce2Digits: true,
                          onTimeChange: (time) {
                            setState(() {
                              selectedtime = time;
                              widget.alarm.alarmTime = TimeOfDay.fromDateTime(time);
                            });
                          },
                        ),
                      ],
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () async {
                        await editAlarm(context, day: widget.day, prevAlarm: widget.prevAlarm, alarm: widget.alarm);
                      },
                      style: ElevatedButton.styleFrom(
