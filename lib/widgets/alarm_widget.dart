    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage((widget.alarm.alarmTime.hour) >= 12
                  ? (widget.alarm.alarmActive) == 1
                      ? "assets/images/night2.png"
                      : "assets/images/night_off.png"
                  : (widget.alarm.alarmActive) == 1
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(
                    width: 35,
                    height: 35,
                    child: Image(image: AssetImage((widget.alarm.snoozeOn == 1) ? 'assets/images/snooze_on.png' : 'assets/images/snooze_off.png'))),
                CupertinoSwitch(
                    ...
                    onChanged: ((value) async {
                      ...
                      await editAlarm(context, day: widget.day, prevAlarm: prevAlarm, alarm: widget.alarm, popScreen: false);
